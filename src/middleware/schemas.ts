...
export const User = z.object({
    ...
    name:z.string().min(5,'at least 5 chars').max(50,'at most 50 chars'), 
    username: z
        .string()
    ...
    postsReplies: z.array(z.lazy(()=>replyLazy)).optional(),
...
export const Account = User.pick({  
    ...
    password: z.string().min(8,'at least 8 chars').refine(containsNumber,'Must contain at least 1 number').refine(containsSpecial,'Must contain a special character')
})
.strict();
