...
import authenticated, { isAdmin } from '../middleware/auth.js';
...
// 🔥 require login + admin for this one
router.delete('/:id', authenticated, isAdmin, usersController.adminDeleteUser);
